...
setup(
    ...
    description='''Extension for configuring and adding user roles and permissions''',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/thehyve/ckanext-configpermission',

    # Author details
    author='''The Hyve''',
    author_email='''frank@thehyve.nl''',
